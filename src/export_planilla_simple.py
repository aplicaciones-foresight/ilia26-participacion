...
def GUIA_ROWS(nin,nout):
    return [
     ...
     ["Qué alimenta el cálculo","Sub1 (Uso): Tipos de proceso, Etapas de uso, Continuidad/Nivel, Convocante (Público/Privado), Cantidad de iniciativas. Sub2 (Desarrollo, = 2025): Tipo desarrollador, Origen, Tipos de IA."],
    ]
