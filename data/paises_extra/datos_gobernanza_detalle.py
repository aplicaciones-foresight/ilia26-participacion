...
GOBDET["EE"] = {
 ...
 "121": ("Sectores en la ELABORACIÓN (VR p.8/12, PA p.6): GOBIERNO (MKM líder + Justiitsmin., HTM, Riigikantselei, todos los ministerios y agencias) + PRIVADO (eraettevõtted, asociación ITL, consorcios de empresas, teaduspargid) + ACADEMIA (ülikoolid, instituciones de educación/investigación, Eesti Keele Instituut) + SOCIEDAD CIVIL (vabaühendused). → Gob+3 = 4.", "ALTA", [EE_WP, EE_AP]),
