...
GOBDET["SG"] = {
 ...
 "104": ("Estrategia vigente: el Update 2026 (este PDF, 'Refreshed Priorities/Enablers') refresca NAIS 2.0 (2023); decisión del operador: cuenta como estrategia vigente nueva → tramo 2024-25.", "ALTA · decisión operador", [SG_UPD, SG_NAIS]),
 "105": ("2019 → 2.0 (2023) → Update may-2026.", "ALTA", [SG_UPD, SG_OECD]),
 "106": ("Validado: NAIS se revisa periódicamente (1.0 2019 → 2.0 2023 → Update 2026, que evalúa el progreso vs. NAIS 2.0) + 'committed to continually reviewing our actions' (Update p.7) + métricas de proyecto. → 3.", "ALTA", [SG_UPD, SG_NAIS]),
 ...
 "117": ("Género NO es eje con plan → 0. Búsqueda en los 3 PDF: 'gender'/'women' no aparecen como tema; 'diversity' = diversidad lingüística/industria; 'inclusive growth' = capacidades amplias del trabajador (Update p.26), no enfoque de género.", "ALTA", [SG_NAIS, SG_UPD]),
 "118": ("Validado: sostenibilidad como prioridad refrescada — 'Advance resource-efficient AI ... in line with Singapore's sustainability goals' (Update p.3/33) + Green Data Centre Roadmap (p.31) + tema 'Resource-Efficient AI' (NAIS 2.0 p.20). → 1.", "ALTA", [SG_UPD, SG_NAIS]),
 "119": ("Sin mecanismo de participación CIUDADANA en la elaboración: la consulta fue 'in close consultation with AI ecosystem representatives' (NAIS 2.0 p.45) — representantes del ecosistema (cuentan en 121), no público general. Hay consultas públicas para guías puntuales (MGF GenAI, Securing AI), no para la estrategia. → 1.", "ALTA", [SG_NAIS, SG_IMDA]),
 "121": ("Sectores en la ELABORACIÓN: Gob + INDUSTRIA + ACADEMIA + NON-PROFIT. SCAI reunió '40 ... experts from academia, non-profit, industry and government' (NAIS 2.0 p.33); RAISE.SG 'academia, industry, and non-profit' (p.46). → Gob+3 = 4. (Posible 5 con internacional/público.)", "ALTA", [SG_NAIS]),
 "122": ("Sectores en la IMPLEMENTACIÓN: 'A Whole-of-Nation Movement' (NAIS 2.0 p.67); Tripartite Jobs Council = Gob + NTUC (trabajadores) + Employers Federation (Update p.26); AI Verify Foundation (non-profit/comunidad global); co-desarrollo con industria (Update p.18). → Gob+3 = 4 (defendible 5 con internacional/trabajadores).", "ALTA", [SG_SN, SG_AIV]),
 ...
 "128": ("No tiene ley dura de IA; soft law: Model AI Governance Frameworks (2019; GenAI 2024; Agentic 2026, 1º del mundo, Update p.36); 'lighter-touch frameworks' (p.41). → 1. (No es debilidad: marco voluntario muy maduro.)", "ALTA", [SG_MGF, SG_AIV]),
 "129": ("Validado: enfoque por riesgo escalonado — 'interventions that are risk-based, tiered, and adapted for specific ... sectors' (NAIS 2.0 p.59); 'balanced, risk-based approach ... for higher-risk use cases' (Update p.17). En marco voluntario, no ley. → 1.", "ALTA", [SG_NAIS, SG_MGFGEN]),
 "130": ("Validado: AI Verify + Global AI Assurance Sandbox (Update p.37) + PET Sandbox (9 casos en finanzas/salud/publicidad, p.34). → 1.", "ALTA", [SG_AIV]),
