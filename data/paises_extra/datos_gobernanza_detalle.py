...
# ================= ESTONIA =================
GOBDET["EE"] = {
 "103": ("Estrategia de IA desde 2019; vigente el Data & AI White Paper 2024-2030 + Action Plan (Kratt) 2024-26.", "ALTA", [EE_WP, EE_AP, EE_OECD, EE_KRATID]),
 ...
 "106": ("Steering group MKM/MEAC + informes anuales + KPIs. Sin texto primario leído → PRELIM.", "MEDIA · PRELIM", [EE_DIGW, EE_AP]),
 "107": ("€85 millones asignados (2024-2026).", "ALTA", [EE_ERR85, EE_RIIGI]),
 "108": ("Action Plan Kratt 2024-26 con medidas e indicadores.", "ALTA", [EE_AP, EE_KRATID]),
 ...
 "117": ("NO se halló un componente de género con plan de acción → 0.", "MEDIA · NO ENCONTRADO", [EE_WP]),
 "118": ("Mención de 'sustainability tool'; eje ambiental marginal → puntaje BAJA.", "BAJA · PRELIM", [EE_WP, EE_FACT]),
 "119": ("Consultas con industria/academia; debate público 'kratt law' (2017-19) anterior; sin resultados formales publicados.", "MEDIA · PRELIM", [EE_MEDIUM, EE_K4P]),
 "121": ("Elaboración: Gobierno + academia + industria (Gob+2).", "MEDIA · PRELIM", ["https://oecd.ai/en/dashboards/policy-initiatives/national-ai-strategy-10-9801", EE_K4P]),
 "122": ("Implementación: Gobierno + academia + industria + sociedad civil (Gob+3).", "MEDIA · PRELIM", [EE_VALITSUS, EE_RIIGI]),
 ...
 "128": ("EU AI Act (Reg. UE 2024/1689) aplicable; Estonia descartó una 'kratt law' nacional propia.", "ALTA", [EE_ACT, AIACT]),
 "129": ("EU AI Act = enfoque por riesgo (prohibido/alto/limitado/mínimo).", "ALTA", [AIACT, "https://artificialintelligenceact.eu"]),
 "130": ("Sandbox EE-FI (exigido por el EU AI Act); el gobierno ya usa sandboxes.", "ALTA", [EE_SANDBOX]),
