...
GOBDET["EE"] = {
 ...
 "117": ("Género aparece SOLO como métrica (desagregación por sexo de competencias digitales): Valge raamat p.30 'soolist võrdsust mõõdetakse naiste ja meeste osakaaluna...'. No es eje con plan de acción → 0.", "ALTA", [EE_WP]),
 "118": ("Sostenibilidad AMBIENTAL no es arengusuund ni área de acción: 'kestlik areng' (p.6/26) = desarrollo sostenible de la economía de datos; 'rohepööre' aparece 1 vez (p.17). → 0. (Si ILIA toma 'Sostenibilidad' en sentido amplio, sería 1: decisión del operador.)", "ALTA", [EE_WP, EE_AP]),
 "119": ("'Kaasatud osapooled' (Valge raamat p.12): elaboración con ministerios, ITL, universidades, empresas, consorcios y parques científicos — stakeholders organizados, NO una consulta ciudadana abierta con resultados publicados → 2.", "MEDIA-ALTA", [EE_WP, EE_K4P]),
 "121": ("Multistakeholder en la elaboración = Gob + sector privado (ITL, eraettevõtted, consorcios, teaduspargid) + academia (ülikoolid) + sociedad civil (vabaühendused). Valge raamat p.8/12 → Gob+3.", "ALTA", [EE_WP, EE_K4P]),
 "122": ("Implementación vía juhtrühmad (MKM + asutused + 'avaliku sektori välised võtmepartnerid', p.12); áreas del AP: público, privado, academia → Gob+3.", "MEDIA-ALTA", [EE_WP, EE_AP]),
