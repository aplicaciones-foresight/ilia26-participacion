...
- 🇪🇪 EE: Antigüedad=4; **ISO SC42=0** (a verificar). **Validada con texto primario** (Valge raamat/Tegevuskava, ver `gobernanza/VALIDACION_estonia_primaria.md`): cambios Particip. ciudadana(119)=2→5 (>1 mecanismo: 2 encuestas ómnibus 2150 residentes + 220 entrevistas, resultados publicados) y Multistakeholder elab.(121)=3→5 (Gob+4: + ONG + público general); Sostenibilidad(118)=1 y Género(117)=0 confirmados; resto confirmado (PRELIM retirado).
- 🇸🇬 SG: iniciativa legal=1 (soft law). **Validada con texto primario** (NAIS 2019/2.0 2023/Update 2026, ver `gobernanza/VALIDACION_singapur_primaria.md`): único cambio Multistakeholder elab.(121)=3→4; PRELIM retirado de 106/118/119/122/129; Sostenibilidad(118)=1 y Género(117)=0 confirmados; presupuesto >S$1B 2025-2030.
...
**Gobernanza (`gobernanza/`):** `VALIDACION_estonia_primaria.md`, `VALIDACION_singapur_primaria.md` (citas verbatim de los PDF primarios), `REPORTE_gobernanza_5paises.md`, `RUBRICAS_gobernanza.md`, `gobernanza_{estonia,singapur,alemania,espana,portugal}.md`, `gobernanza_estandares_datos_ciber.md` (EE/SG), `gobernanza_estandares_DE_ES_PT.md`, `etica_seguridad_energia.md` (EE/SG), `etica_seguridad_DE_ES_PT.md`, `energia_DE_ES_PT.md`, `FUENTES_gobernanza_EE_SG.md`, `INCERTIDUMBRES_gobernanza_EE_SG.md`, `REPORTE_gobernanza_EE_SG.md`.
