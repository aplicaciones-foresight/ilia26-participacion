...
G = [
 ...
 ("", "Mecanismos de evaluación (106)", "Estrategia", "3","3 (PRELIM)","3","3","3",""),
 ...
 ("", "Multistakeholder elaboración (121)", "Estrategia", "5","3 (PRELIM)","4 (PRELIM)","4 (PRELIM)","5","EE: Gob+4 (privado + academia + ONG vabaühendused + público general/encuestas 2150), p.8/12 + PA p.6; PT: Gob+4"),
